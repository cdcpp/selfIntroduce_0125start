				...
				<div class="col-md-12 col-lg-10">
					<div class="wrap d-md-flex">
						<div class="text-wrap p-4 p-lg-5 text-center d-flex align-items-center order-md-last">
							<div class="text w-100">
								...
								<p>계정을 잊으셨나요?</p>
								<button type="button" id="openEmailModal" class="btn btn-white btn-outline-white">회원가입</button>
							</div>
			      </div>
			      	...
			      	<div class="d-flex">
			      		...
			      		<div class="form-group mb-3">
			      			...
			      			<input type="text" class="form-control" placeholder="Email" id="memberId" name="memberId" value="${cookie.user_id.value}" required>
			      		</div>
		            <div class="form-group mb-3">
		            	<label class="label" for="password">Password</label>
		              <input type="password" class="form-control" placeholder="Password" id="memberPwd" name="memberPwd" required>
		            </div>
		            <div class="form-group">
		            	<button id="loginBtn" onclick="doLogin();" type="button" class="form-control btn btn-primary submit px-3">Login</button>
		            </div>
		            
		              <div class="form-group">
		            	<button id="nonloginBtn"  type="button" class="form-control btn btn-primary submit px-3">non-member Login</button>
		            	<br><br>
		            ...
		            <div class="form-group d-md-flex">
		            	<div class="w-50 text-left">
			            	<label class="checkbox-wrap checkbox-primary mb-0">ID 저장
									  <input type="checkbox" checked id="checkSaveId" name="checkSaveId">
  ...
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      ...
      <div class="modal-body">
         	회원가입할 이메일 / 패스워드를 양식에 맞춰 작성 후 이메일 
         	보내기 버튼을 클릭해주세요.
         	관리자 승인 후 가입 완료되며, 환영 메일이 발송됩니다
      </div>
		  ...
		  <input type="text" class="form-control" id="join-email">
						...
						<div class="form-group">
							<label for="pwd">Password:</label> <input type="password"
								class="form-control" id="join-password">
						</div>
